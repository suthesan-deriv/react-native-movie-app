...
import {ADD_FAVOURITES, ADD_FAVOURITES_SUCCESS, LOAD_COMING_SOON, LOAD_COMING_SOON_SUCCESS} from '../actions/actions'

function comingSoonApi() {
    return axios.get('https://imdb-api.com/en/API/ComingSoon/k_a6m0szqh').then(response => response.data)
}
